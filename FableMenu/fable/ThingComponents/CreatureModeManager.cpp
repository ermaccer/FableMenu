...
bool CTCCreatureModeManager::AddMode(NCreatureMode::EMode mode)
{
...
void CTCCreatureModeManager::RemoveMode(NCreatureMode::EMode mode)
{
...
bool CTCCreatureModeManager::IsModeActive(NCreatureMode::EMode mode)
{
